<?php
    ...
    if (isset($_POST["id"]) && !empty($_POST["id"])) {
        ...
        if (
            ...
            && empty($ocupacion_madre_err) && empty($identificacion_madre_err) && empty($fecha_matricula_err) && empty($clase1_err)
        ...
        acudiente, eps, direccion, tipo_identificacion, genero, fecha_nacimiento, edad, rh, lugar_nacimiento, estrato, barrio,
        telefono_estudiante, ocupacion_padre, identificacion_padre, ocupacion_madre, identificacion_madre, correo, fecha_matricula, clase1, horario1, clase2, horario2, clase3, horario3, t_fracaso, 
        t_fracaso_com, t_fracaso_niv, s_problemas, s_problemas_com, s_problemas_niv, c_concentracion, 
        c_concentracion_com, c_concentracion_niv, c_concentracion_mej, c_concentracion_mej_com, email_user, password, role, username) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            if ($stmt = mysqli_prepare($link, $sql)) {
                ...
                mysqli_stmt_bind_param(
                    $stmt,
                    "ssissssisissssssissisisisissssssssssissississssis",
                    $param_nombres,
                    $param_apellidos,
        ...
        <div class="fondo_pag">
            <div class="text-center fondo_img h-100">
                ...
                <div class="container text-center py-4">
                    <h2>Agregar a otro hij@</h2>
                </div>

                <p>Complete este formulario y envíelo para agregar el registro a la base de datos.</p>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 mx-auto">
                                <div class="form-group <?php echo (!empty($fecha_matricula_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($tipo_identificacion_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($fecha_nacimiento_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($lugar_nacimiento_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($colegio_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($grado_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div
                                    class="form-group <?php echo (!empty($telefono_estudiante_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($madre_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($identificacion_madre_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($ocupacion_madre_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($padre_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($identificacion_padre_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($ocupacion_padre_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($telefono1_err)) ? 'has-error' : ''; ?>">
                                    <label>Numero de contacto</label>
                            ...
                            <div class="col-6 mx-auto">
                                <div class="form-group <?php echo (!empty($acudiente_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($eps_err)) ? 'has-error' : ''; ?>">
                            ...
                            <!-- hacer verificacion -->
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($t_fracaso_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($t_fracaso_niv_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div style="width:100%; float:left;">
                                <div class="form-group <?php echo (!empty($t_fracaso_com_err)) ? 'has-error' : ''; ?>">
                                    <label>¿Por qué?</label>
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($s_problemas_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($s_problemas_niv_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-12 py-1 ">
                                <div class="form-group <?php echo (!empty($s_problemas_com_err)) ? 'has-error' : ''; ?>">
                                    <label>¿Por qué?</label>
                            ...
                            <div class="col-md-12 col-lg-6 py-1 mx-auto">
                                <div class="form-group <?php echo (!empty($c_concentracion_mej_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-12 py-1">
                                <div class="form-group <?php echo (!empty($c_concentracion_mej_com_err)) ? 'has-error' : ''; ?>">
                                    <label>¿Por qué?</label>
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($c_concentracion_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($c_concentracion_niv_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-12 py-1">
                                <div class="form-group <?php echo (!empty($c_concentracion_com_err)) ? 'has-error' : ''; ?>">
                                    <label>¿Por qué?</label>
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($clase1_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-md-12 col-lg-6 py-1">
                                <div class="form-group <?php echo (!empty($horario1_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-12 py-2 form-group" id="oculto2" style="display:none;">
                                <div class="row">
                                    <div class="col-md-12 col-lg-6 py-1">
                                        <div class="form-group <?php echo (!empty($clase2_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <div class="col-md-12 col-lg-6 py-1">
                                        <div class="form-group <?php echo (!empty($horario2_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="col-12 py-2 form-group" id="oculto3" style="display:none;">
                                <div class="row">
                                    <div class="col-md-12 col-lg-6 py-1">
                                        <div class="form-group <?php echo (!empty($clase3_err)) ? 'has-error' : ''; ?>">
                                    ...
                                    <div class="col-md-12 col-lg-6 py-1">
                                        <div class="form-group <?php echo (!empty($horario3_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div style="width:100%; float:left;">
                                <div class="opciones">
                                    <div class="center">
                                        <button class="btn btn_rvf1" type="submit">Guardar</button>
                                        <a class="btn btn_rvf2" href="../proceso/fecha.php">Regresar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
