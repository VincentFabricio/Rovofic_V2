            ...
            <div class="text-center fondo_img h-100">
                    ...
                    <div class="page-body ">
                                ...
                                <?php
                                    ...
                                    echo "<thead>";
                                    echo "<tr>";
                                    echo "<th style='width:40%;' onclick='sortTable(1,1)'>ESTUDIANTE</th>";
                                    echo "<th style='width:30%;' onclick='sortTable(2,1)'>FECHA</th>";
                                    echo "<th style='width:30%;'>OPCIONES</th>";
                                    echo "</tr>";
                                    echo "</thead>";
                                    echo "<tbody id='tbody'>";
                                   /*  $row = mysqli_fetch_array($result3);
                                    ...
                                    while ($row = mysqli_fetch_array($result3)) {
                                        ...
                                        /* echo "<a id='btt_lupa_padres' target='_blank' class='mx-1 my-1' href='read1.php?fecha=" . $row['fecha'] . "&est=".$row['estudiante']."' title='Buscar procesos'><img src='../Ass/img/Icons/ver.webp' class='Icons_h'></a>"; */
                                        echo "<button onclick=window.location.href='read1.php?fecha=" . $row['fecha'] . "&est=".$row['estudiante']."' id='btt_lupa_padres' class='mx-1 my-1' title='Buscar procesos'><img src='../Ass/img/Icons/ver.webp' class='Icons_h'></button>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";
                                ...
                                <?php
                                    if ($_SESSION['role'] == 2) {
                                        ...
                                        echo " <div class='col-8 mx-auto py-2 mt-3'> ";
                                        echo " <a class='' href='../indexs/nuevoHijo.php?id=" . $row3['id'] . "'>Agregar otro hijo(a)</a>";
                                        echo " </div>";
                                    }
                                    ?>
