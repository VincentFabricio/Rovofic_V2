<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($input_name)) {
            $name_err = "Por favor ingrese el name.";
        } else {
            $name = $input_name;
        }
        ...
        if (empty($input_description)) {
            $description_err = "Por favor ingrese la description.";
        } else {
        ...
        if (
            ...
            $sql = "INSERT INTO compras (keyy, amount, tax, tax_base, name, description, amount2, tax2, tax_base2, description2) 
        VALUES (?,?,?,?,?,?,?,?,?,?)";
            ...
            <div class="text-center fondo_img h-100">
                    ...
                    <div class="page-header pt-4 pb-3">
                             ...
                             <p class="col-10 mx-auto">
                                Complete y guarde el registro</p>
                         </div>
                         ...
                         <form class="page-body" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            ...
                            <div class="col-11 mx-auto py-3">
                                <div class="col_btn pb-1">
                                    <a class="btn btn_rvf1" onclick="ocultarismo()">Agregar</a>
                                </div>
                                <div class="col_btn" id="ocultoBtt" style="display:block;">
                                    <a class="btn btn_rvf2" onclick="resetOcult()">Restaurar</a>
                                </div>
                            </div>
