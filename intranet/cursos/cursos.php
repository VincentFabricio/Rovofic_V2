...
<body>
    ...
    <div class="container-fluid">
        <div class="fondo_pag">
            <div class="text-center fondo_img h-100">
                        ...
                        <!--div class="page-body h-75 pb-5 overflow-auto"-->
                        <div class="page-body">
                            <?php
                            // Include config file
                            ...
                            if ($result = mysqli_query($link, $sql)) {
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    echo "<thead>";
                                    echo "<tr>";
                                    echo "<th style='width:3%;'><a href='create.php' title='Agregar curso'><img src='../Ass/img/Icons/agregar.webp' class='Icons_hh'></a></th>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<th style='width:10%;' onclick='sortTable(0,1)' >CODIGO</th>";
                                    echo "<th style='width:40%;' onclick='sortTable(1,1)'>TITULO</th>";
                                    echo "<th style='width:10%;' onclick='sortTable(2,1)'>TEMA</th>";
                                    echo "<th style='width:10%;' onclick='sortTable(3,1)'>NIVEL</th>";
                                    echo "<th style='width:10%;' onclick='sortTable(4,1)'>CLASE</th>";
                                    /* echo "<th style='width:10%;' onclick='sortTable(5,1)'>ENLACE</th>"; */
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td class='text-justify'>" . $row['titulo'] . "</td>";
                                        echo "<td class='text-justify'>" . $row['tema'] . "</td>";
                                        echo "<td class='text-center'>" . $row['nivel'] . "</td>";
                                        echo "<td class='text-center'>" . $row['clase'] . "</td>";
                                        /* echo "<td class='text-center'>" . $row['enlace'] . "</td>"; */
                                        echo "<td class='text-center'>";
                                        echo "<a class='m-auto' href='update.php?id=". $row['id'] ."' title='Modificar curso'><img src='../Ass/img/Icons/editar.webp' class='Icons_h'></a>";
                                        echo "<a class='m-auto' href='delete.php?id=". $row['id'] ."' title='Eliminar curso'><img src='../Ass/img/Icons/eliminar.webp' class='Icons_h'></a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";
    ...
    <script src="../Ass/js/bootstrap.min.js"></script></body></body></body>
